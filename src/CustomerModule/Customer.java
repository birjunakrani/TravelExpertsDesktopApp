...
public Customer()
{
     customerId=new SimpleIntegerProperty();
      custFirstName=new SimpleStringProperty();
     custLastName=new SimpleStringProperty();
     custAddress=new SimpleStringProperty();
     custCity=new SimpleStringProperty();
    custProv=new SimpleStringProperty();
    custPostal=new SimpleStringProperty();
   custCountry=new SimpleStringProperty();
     custHomePhone=new SimpleStringProperty();
    custBusPhone=new SimpleStringProperty();
    custEmail=new SimpleStringProperty();
